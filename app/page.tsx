    ...
    <main style={{ minHeight: '100vh', paddingBottom: 100, background: '#5b7fd4' }}>
      ...
      <div style={{ padding: '16px 16px 0', maxWidth: 400, margin: '0 auto' }}>
        ...
        <div style={{ marginTop: 20 }}>
          <p style={{ textAlign: 'center', fontSize: 11, fontWeight: 800, color: 'rgba(255,255,255,0.85)', marginBottom: 10, textTransform: 'uppercase', letterSpacing: '0.08em' }}>
